...
public class ExportAB
{
    ...
    [MenuItem("AB包导出/Windows1")]
    public static void NewForWindows()
    {
        NewExport(BuildTarget.StandaloneWindows);
    }
    [MenuItem("AB包导出/Mac")]
    ...
    {
        string path = Config.STEARINGASSET_PATH;
    ...
    private static void NewExport(BuildTarget platform)
    {
        string path = Config.ABDATA_PATH;
        //path = path.Substring(0, path.Length - 6) + "ab";
